...
The scripts in this section are for machines that will build generated C++ projects, run sanitizer
lanes, or exercise Vulkan/CUDA lanes. The repo's own default validation needs only the basic
requirements above.
...
After installing GPU tools, verify the active shell before blaming a generated project:
