...
- 2026-06-21T00:29:02Z [global] CppStudio native GPU renderer/viewport/grooming performance fixes must preserve the full-quality target by default: LOD, decimation, lower samples/resolution, disabled lighting/shadows/scattering, cheaper primitives, proxy/cache/impostor paths, and idle/final-only updates are diagnostics or explicit scalability choices, not optimization fixes; when high-FPS peers or cutting-edge expectations are named, require current peer/donor architecture research before source changes and close only with same-quality visual proof plus timing/profiler improvement. (source: self-improvement:user_correction:f99b833b96bd0280)
