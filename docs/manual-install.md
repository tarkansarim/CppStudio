...
- the managed `cpp-cuda-vulkan-studio`, `native-cpp-gui-hud`, `cppstudio-project-planner`, and
  `agentic-control-harness` skill folders
...
skill_names=("cpp-cuda-vulkan-studio" "native-cpp-gui-hud" "cppstudio-project-planner" "agentic-control-harness")
...
$SkillNames = @("cpp-cuda-vulkan-studio", "native-cpp-gui-hud", "cppstudio-project-planner", "agentic-control-harness")
