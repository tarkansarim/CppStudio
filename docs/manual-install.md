...
- the managed `cpp-cuda-vulkan-studio` and `native-cpp-gui-hud` skill folders
...
skill_names=("cpp-cuda-vulkan-studio" "native-cpp-gui-hud")
...
$SkillNames = @("cpp-cuda-vulkan-studio", "native-cpp-gui-hud")
