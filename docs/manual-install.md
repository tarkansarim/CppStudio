...
- the managed `cpp-cuda-vulkan-studio`, `native-cpp-gui-hud`, and `cppstudio-project-planner` skill folders
...
skill_names=("cpp-cuda-vulkan-studio" "native-cpp-gui-hud" "cppstudio-project-planner")
...
$SkillNames = @("cpp-cuda-vulkan-studio", "native-cpp-gui-hud", "cppstudio-project-planner")
