...
- README Recent Commit Highlights shows 10 selected recent highlight entries by default and keeps
  older entries under a GitHub `<details>` expander so the front page remains scannable.
