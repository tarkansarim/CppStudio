...
| --- | --- | --- |
| Character Art | Characters, creatures, gear, weapons, high-poly sculpting, brush workflows, hair cards/grooms, runtime LODs, mesh/material budgets. | [sculpting-brushes.md](../sculpting-brushes.md), [assets-meshes-materials.md](../assets-meshes-materials.md), [hair-grooming-fur.md](../hair-grooming-fur.md), [animation-rigging.md](../animation-rigging.md), [texture-material-color.md](../texture-material-color.md) |
...
| Technical Art | Artist tooling, brush/sculpt tooling, shader/material tooling, procedural pipelines, export validation, build/cook workflows, performance fixes, editor panels, and debug HUDs. | [native-engineering-infrastructure.md](../native-engineering-infrastructure.md), [native-gui-hud.md](../native-gui-hud.md), [sculpting-brushes.md](../sculpting-brushes.md), [assets-meshes-materials.md](../assets-meshes-materials.md), [graphics-rendering.md](../graphics-rendering.md) |
